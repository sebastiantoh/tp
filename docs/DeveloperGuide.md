...
4.  The application, along with all my existing data, should be portable.
5.  Should be able to function without having to rely on being connected to a network.
