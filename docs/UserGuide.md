...
3. [**Features**](#features)
    ...
    3. [Listing all contacts: `contact list`](#listing-a-contact-contact-list)
    ...
    2. [Listing all tags: `tag list`](#listing-all-tag-tag-list)
    ...
    3.4. [Scheduled Appointments](#4-deleting-a-task-delete)
