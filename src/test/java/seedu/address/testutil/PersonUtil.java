...
public class PersonUtil {
    ...
    public static String getPersonDetails(Person person) {
        ...
        sb.append(PREFIX_CONTACT_NAME + person.getName().fullName + " ");
        sb.append(PREFIX_CONTACT_PHONE + person.getPhone().value + " ");
        sb.append(PREFIX_CONTACT_EMAIL + person.getEmail().value + " ");
        sb.append(PREFIX_CONTACT_ADDRESS + person.getAddress().value + " ");
    ...
    public static String getEditPersonDescriptorDetails(EditPersonDescriptor descriptor) {
        StringBuilder sb = new StringBuilder();
        descriptor.getName().ifPresent(name -> sb.append(PREFIX_CONTACT_NAME).append(name.fullName).append(" "));
        descriptor.getPhone().ifPresent(phone -> sb.append(PREFIX_CONTACT_PHONE).append(phone.value).append(" "));
        descriptor.getEmail().ifPresent(email -> sb.append(PREFIX_CONTACT_EMAIL).append(email.value).append(" "));
        descriptor.getAddress().ifPresent(address -> sb.append(PREFIX_CONTACT_ADDRESS).append(address.value).append(" "));
