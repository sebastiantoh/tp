...
public class TypicalSales {
    ...
    public static final Sale APPLE = new SaleBuilder().withItemName("Apple")
            .withBuyer(BENSON).withQuantity("10")
    ...
    public static final Sale CAMERA = new SaleBuilder().withItemName("Camera").withBuyer(CARL)
            .withQuantity("2")
            .withDatetimeOfPurchase(LocalDateTime.of(2020, 11, 1, 9, 5))
            .withUnitPrice(new BigDecimal("1000.5")).withTags("electronics").build();
    public static final Sale GUITAR = new SaleBuilder().withItemName("Fender guitar").withBuyer(BENSON)
            .withQuantity("5")
            .withDatetimeOfPurchase(LocalDateTime.of(2020, 11, 1, 9, 5))
            .withUnitPrice(new BigDecimal("7000.0")).withTags("electronics").build();
    public static final Sale DRUMS = new SaleBuilder().withItemName("Yamaha Drum set").withBuyer(BENSON)
            .withQuantity("1")
            .withDatetimeOfPurchase(LocalDateTime.of(2020, 11, 1, 9, 5))
