...
public class Remark {
    ...
    /**
     * Returns true if a given string is a valid remark input.
     * Only used to validate remarks upon creation or updating of contact object.
     */
    public static boolean isValidRemarkInput(String test) {
